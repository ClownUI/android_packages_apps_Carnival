...
import com.clown.settings.fragments.lockscreen.UdfpsAnimation;
import com.clown.settings.fragments.lockscreen.UdfpsIconPicker;
...
public class LockScreen extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.clown_settings_lockscreen);
        ...
        if (mFingerprintManager == null || !mFingerprintManager.isHardwareDetected()) {
            ...
            if (!Utils.isPackageInstalled(getContext(), "com.clown.udfps.animations")) {
                gestCategory.removePreference(mUdfpsAnimations);
            }
            if (!Utils.isPackageInstalled(getContext(), "com.clown.udfps.icons")) {
                gestCategory.removePreference(mUdfpsIcons);
            }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.clown_settings_lockscreen) {
