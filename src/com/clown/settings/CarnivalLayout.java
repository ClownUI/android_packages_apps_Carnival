...
import com.clown.settings.fragments.About;
import com.clown.settings.fragments.Buttons;
import com.clown.settings.fragments.LockScreen;
import com.clown.settings.fragments.Miscellaneous;
import com.clown.settings.fragments.Navigation;
import com.clown.settings.fragments.Notifications;
import com.clown.settings.fragments.QuickSettings;
import com.clown.settings.fragments.Sound;
import com.clown.settings.fragments.StatusBar;
import com.clown.settings.fragments.UserInterface;

public class CarnivalLayout extends SettingsPreferenceFragment {

    private static final String TAG = "CarnivalLayout";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.clown_settings_title);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContainer = container;
        View view = inflater.inflate(R.layout.carnival_settings, container, false);
    ...
    private String[] getTitles() {
        ...
        titleString = new String[] {
            ...
            getString(R.string.about_clown)
        };
        return titleString;
    }
